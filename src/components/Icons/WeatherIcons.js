...
function WeatherIcon(props) {
  ...
  if (weather.includes("обл") || weather.includes("пасмурно")) {
    return (
  ...
  if (weather.includes("снег")) {
    return (
      <svg
        ...
        viewBox="70 0 1280.000000 989.000000"
        className={nameClass}
      >
        <g
